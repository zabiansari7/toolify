...
public class ProductDto {
	...
	public String toString() {
		return "ProductDto [productId=" + productId + ", name=" + name + ", description=" + description + ", price="
				+ price + ", quantity=" + quantity + ", manufacturer=" + manufacturer + ", voltage=" + voltage
				+ ", productDimensions=" + productDimensions + ", itemWeight=" + itemWeight + ", bodyMaterial="
				+ bodyMaterial + ", itemModelNumber=" + itemModelNumber + ", design=" + design + ", colour=" + colour
				+ ", batteriesRequired=" + batteriesRequired + ", image=" + image + ", category=" + category + "]";
	}
