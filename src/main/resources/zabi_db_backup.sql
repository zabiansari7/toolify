...
CREATE TABLE `users` (
  ...
  `createdOn` datetime DEFAULT NULL,
  `defaultCity` varchar(255) DEFAULT NULL,
  `defaultPincode` bigint DEFAULT NULL,
  `defaultStreetName` varchar(255) DEFAULT NULL,
  `defaultStreetNumber` int DEFAULT NULL,
  `hasRole` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2023-12-01 23:52:38
